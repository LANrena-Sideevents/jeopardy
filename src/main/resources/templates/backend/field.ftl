    ...
    <form method="post"
        ...
        <div class="form-group">
            <div class="btn-group btn-group-lg" data-toggle="buttons">
                <label class="btn btn-primary btn-warning active">
                    <input type="radio" name="player" value="" autocomplete="off" checked="checked"/>None
                </label>
                <label class="btn btn-primary" th:each="player : ${game.players}">
                    <input type="radio" name="player" th:value="${player.id}" autocomplete="off"/>
        ...
        <div class="form-group input-group-lg"
            ...
            <input type="number" step="100"
                   ...
                   th:aria-describedby="@{|label${player.id}|}"
