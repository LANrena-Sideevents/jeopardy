...
<head>
    ...
    <script type="text/javascript" src="/webjars/knockout/3.5.1/knockout.js"></script>
    <script type="text/javascript" src="/js/jeopardyclient.js"></script>

    <link rel="stylesheet" href="/css/jeopardy.css"/>
    <link rel="stylesheet" href="/css/8bit-style.css"/>
</head>
<body>
